...
namespace StudentskiHotel.Data.Migrations
{
    ...
    [Migration("20180724222309_inicijalna")]
            ...
            modelBuilder.Entity("StudentskiHotel.Data.EntityModels.RacunRestoran", b =>
                {
                    ...
                    b.HasOne("StudentskiHotel.Data.EntityModels.StavkaRacuna", "StavkaRacuna")
                        .WithMany()
                        .HasForeignKey("StavkaRacunaID")
                        .OnDelete(DeleteBehavior.Cascade);
                });
